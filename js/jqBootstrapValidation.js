        ...
        return this.each(function(){
          ...
          if (settings.options.sniffHtml) {
            ...
            if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "email") {
              message = "Nieprawidłowy adres email<!-- data-validator-validemail-message to override -->";
      ...
      ajax: {
		...
		builtInValidators: {
			...
			passwordagain: {
				...
				type: "match",
				match: "password",
				message: "Podane hasło nie pokrywa się.<!-- data-validator-paswordagain-message to override -->"
			},
			positive: {
				name: "Positive",
				type: "shortcut",
			...
			number: {
				...
				type: "regex",
				regex: "([+-]?\\\d+(\\\.\\\d*)?([eE][+-]?[0-9]+)?)?",
				message: "Musi być numer<!-- data-validator-number-message to override -->"
			},
			integer: {
				name: "Integer",
				type: "regex",
